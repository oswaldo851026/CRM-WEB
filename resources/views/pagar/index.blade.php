...
@section('content')
    ...
    <div class="container">
        <div class="row">
          ...
          <tbody>
            <?php if (count($listacuentas_pagar) > 0): ?>
          <?php foreach ($listacuentas_pagar as $row): ?>
            <tr>
    					<td style = "width:10%;">{{$row->idcuentas_pagar}}</td>
    					<td style = "width:10%;">{{$row->detalle_pedidos}}</td>
    					<td style = "width:10%;">{{$row->cliente}}</td>
