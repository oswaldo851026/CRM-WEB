...
<!--Primera columna -->
		<div class="col-xs-6">
			...
			<input type="text" value= "{{$almacen->nombre_almacen}}" tabindex="1" name="nombre_almacen" id= 'nombre_almacen' class="form-control" placeholder="nombre del almacen" required> <br/>
			</div>
			</div>
			...
			<input type="number" value= "{{$almacen->prioridad_entrada}}" tabindex="3" name="prioridad_entrada" id= 'prioridad_entrada' class="form-control" placeholder="Escriba un numero. El numero menor es prioritario" > <br/>
			</div>
			</div>
 ...
 <!--Segunda columna -->
      ...
      <div class="form-group" >
			...
			<input type="text" tabindex="2" value= "{{$almacen->descripcion}}" name="descripcion" id= 'descripcion' class="form-control" placeholder="descripcion breve del almacen" required> <br/>
			</div>
			</div>
			...
			<input type="number" tabindex="4" name="prioridad_salida" id= 'prioridad_salida' value= "{{$almacen->prioridad_salida}}" class="form-control" placeholder="Escriba un numero. El numero menor es prioritario" required> <br/>
			</div>
			</div>
			...
			<input type="number" tabindex="6"  value= "{{$almacen->capacidad}}" name="capacidad" id= 'capacidad' class="form-control" placeholder="capacidad" required> <br/>
			</div>
			</div>
