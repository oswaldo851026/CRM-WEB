...
<!--Primera columna -->
		<div class="col-xs-6">
			...
			<input type="text" tabindex="1" name="nombre" id= 'nombre' value="{{$categorias->nombre}}" class="form-control" placeholder="nombre" required> <br/>
			</div>
			</div>
 ...
 <!--Segunda columna -->
      ...
      <div class="form-group" >
			...
			<input type="text" tabindex="2" name="descripcion" value="{{$categorias->descripcion}}" id= 'email' class="form-control" placeholder="descripcion" required> <br/>
			</div>
			</div>
	 </div>
