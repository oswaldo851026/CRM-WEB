    ...
    <div class="container">
        <div class="row">
          ...
          <div class="panel-body">
           <div class="col-md-6">
           <a href="{{ url('materiaprima/create') }}" class="btn btn-success btn-sm" title="Agregar un nuevo producto">
          ...
          <?php foreach ($materiaprima as $row): ?>
            <tr>
              ...
              <a href="{{url('materiaprima/'.$row->idmateriaprimas)}}" class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a>
    					<a href="{{url('materiaprima/'.$row->idmateriaprimas.'/edit')}}" class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></a>
